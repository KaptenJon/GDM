...
//    //this attributes makes the debugger display the value without braces or quotes
...
//        /// </summary>
//        public static readonly Quad Zero = new Quad(0UL, long.MinValue);
//            //there is only one zero; all other significands with exponent long.MinValue are invalid.
...
//            this.SignificandBits |= ~highestBit & (((ulong) significand) << shift);
//                //mask out the highest bit--it's implicit
...
//        private static readonly double[] specialDoubleLogTable = new double[]
//        {double.NegativeInfinity, double.PositiveInfinity, double.NaN, double.NaN};
...
//            {
//                Quad result =
//                    specialMultiplicationTable[
//                        (int) (this.Exponent - zeroExponent),
//                        multiplier.Exponent > notANumberExponent
//                            ? (int) (4 + (multiplier.SignificandBits >> 63))
//                            : (int) (multiplier.Exponent - zeroExponent)];
...
//                Quad result =
//                    specialMultiplicationTable[
//                        (int) (4 + (this.SignificandBits >> 63)), (int) (multiplier.Exponent - zeroExponent)];
//                this.SignificandBits = result.SignificandBits;
//                this.Exponent = result.Exponent;
//                return;
//            }
...
//            ulong significandBits = high1*high2 + (((this.SignificandBits & lowWordMask)*high2) >> 32) +
//                                    ((high1*(multiplier.SignificandBits & lowWordMask)) >> 32);

//            long qd2Exponent;
//            long qd1Exponent = this.Exponent;
//            if (significandBits < (1UL << 63))
//            {
//                this.SignificandBits = ((this.SignificandBits ^ multiplier.SignificandBits) & highestBit) |
//                                       ((significandBits << 1) & ~highestBit);
...
//            if (qd2Exponent < 0 && this.Exponent > qd1Exponent)
//                //did the exponent get larger after adding something negative?
//            {
//                this.SignificandBits = 0;
//                this.Exponent = zeroExponent;
//            }
//            else if (qd2Exponent > 0 && this.Exponent < qd1Exponent)
//                //did the exponent get smaller when it should have gotten larger?
//            {
//                this.SignificandBits = 0;
...
//                    {
//                        Quad result =
//                            specialAdditionTable[
//                                (int) (this.Exponent - zeroExponent),
//                                value.Exponent > notANumberExponent
//                                    ? (int) (4 + (value.SignificandBits >> 63))
//                                    : (int) (value.Exponent - zeroExponent)];
//                        this.SignificandBits = result.SignificandBits;
//                        this.Exponent = result.Exponent;
//                    }
...
//                        Quad result =
//                            specialAdditionTable[
//                                (int) (4 + (this.SignificandBits >> 63)), (int) (value.Exponent - zeroExponent)];
//                        this.SignificandBits = result.SignificandBits;
//                        this.Exponent = result.Exponent;
//                    }
...
//                if ((this.SignificandBits ^ value.SignificandBits) >= highestBit)
//                    //this and value have different signs--use subtraction instead
//                {
...
//                    else
//                    {
//                        ulong bits = (this.SignificandBits | highestBit) +
//                                     ((value.SignificandBits | highestBit) >> (int) (this.Exponent - value.Exponent));
...
//                    else
//                    {
//                        ulong bits = (value.SignificandBits | highestBit) +
//                                     ((this.SignificandBits | highestBit) >> (int) (value.Exponent - this.Exponent));
...
//                    this.SignificandBits = ((this.SignificandBits + value.SignificandBits) >> 1) |
//                                           (this.SignificandBits & highestBit);
//                    this.Exponent = this.Exponent + 1;
//                }
//            }
...
//            if ((this.SignificandBits ^ value.SignificandBits) >= highestBit)
//                //this and value have different signs--use addition instead            
//            {
...
//                    //make sure MSB is 1                       
//                    int highestBitPos = nlz(bits);
//                    this.SignificandBits = ((bits << highestBitPos) & ~highestBit) |
//                                           (~value.SignificandBits & highestBit);
...
//                {
//                    ulong bits = value.SignificandBits - this.SignificandBits;
//                        //notice that we don't worry about de-implicitizing the MSB--it'd be eliminated by subtraction anyway
//                    int highestBitPos = nlz(bits);
//                    this.SignificandBits = ((bits << highestBitPos) & ~highestBit) |
//                                           (~value.SignificandBits & highestBit);
//                    this.Exponent = value.Exponent - highestBitPos;
...
//                {
//                    ulong bits = this.SignificandBits - value.SignificandBits;
//                        //notice that we don't worry about de-implicitizing the MSB--it'd be eliminated by subtraction anyway
//                    int highestBitPos = nlz(bits);
//                    this.SignificandBits = ((bits << highestBitPos) & ~highestBit) | (this.SignificandBits & highestBit);
//                    this.Exponent = this.Exponent - highestBitPos;
...
//            {
//                Quad result =
//                    specialDivisionTable[
//                        (int) (this.Exponent - zeroExponent),
//                        divisor.Exponent > notANumberExponent
//                            ? (int) (4 + (divisor.SignificandBits >> 63))
//                            : (int) (divisor.Exponent - zeroExponent)];
//                this.SignificandBits = result.SignificandBits;
//                this.Exponent = result.Exponent;
//                return;
//            }
...
//                Quad result =
//                    specialDivisionTable[
//                        (int) (4 + (this.SignificandBits >> 63)), (int) (divisor.Exponent - zeroExponent)];
//                this.SignificandBits = result.SignificandBits;
//                this.Exponent = result.Exponent;
//                return;
//            }
...
//            {
//                this.SignificandBits = (~highestBit & (thisAdjSignificand << 1)) |
//                                       ((this.SignificandBits ^ divisor.SignificandBits) & highestBit);
...
//            else
//            {
//                this.SignificandBits = (~highestBit & thisAdjSignificand) |
//                                       ((this.SignificandBits ^ divisor.SignificandBits) & highestBit);
...
//                return
//                    specialDivisionTable[
//                        (int) (qd1.Exponent - zeroExponent),
//                        qd2.Exponent > notANumberExponent
//                            ? (int) (4 + (qd2.SignificandBits >> 63))
//                            : (int) (qd2.Exponent - zeroExponent)];
//            else if (qd2.Exponent <= notANumberExponent) //finite divided by zero/infinity/NaN            
//                return
//                    specialDivisionTable[(int) (4 + (qd1.SignificandBits >> 63)), (int) (qd2.Exponent - zeroExponent)];
...
//            {
//                result.SignificandBits = (~highestBit & (qd1AdjSignificand << 1)) |
//                                         ((qd1.SignificandBits ^ qd2.SignificandBits) & highestBit);
...
//            else
//            {
//                result.SignificandBits = (~highestBit & qd1AdjSignificand) |
//                                         ((qd1.SignificandBits ^ qd2.SignificandBits) & highestBit);
...
//            }
//            else
//                return new Quad(qd.SignificandBits ^ highestBit, qd.Exponent);
//                    //just swap the sign bit                        
//        }
...
//                    return
//                        specialAdditionTable[
//                            (int) (4 + (qd1.SignificandBits >> 63)), (int) (qd2.Exponent - zeroExponent)];
//            }

//            if ((qd1.SignificandBits ^ qd2.SignificandBits) >= highestBit)
//                //qd1 and qd2 have different signs--use subtraction instead
//            {
...
//                else
//                {
//                    ulong bits = (qd1.SignificandBits | highestBit) +
//                                 ((qd2.SignificandBits | highestBit) >> (int) (qd1.Exponent - qd2.Exponent));
...
//                else
//                {
//                    ulong bits = (qd2.SignificandBits | highestBit) +
//                                 ((qd1.SignificandBits | highestBit) >> (int) (qd2.Exponent - qd1.Exponent));
...
//                //the MSB must have the same sign, so the MSB will become 0, and logical overflow is guaranteed in this situation (so we can shift right and increment the exponent).
//                result =
//                    new Quad(((qd1.SignificandBits + qd2.SignificandBits) >> 1) | (qd1.SignificandBits & highestBit),
//                        qd1.Exponent + 1);
//            }
...
//            if ((qd1.SignificandBits ^ qd2.SignificandBits) >= highestBit)
//                //qd1 and qd2 have different signs--use addition instead
//            {
//                return qd1 + new Quad(qd2.SignificandBits ^ highestBit, qd2.Exponent);
//            }
...
//                    //make sure MSB is 1                       
//                    int highestBitPos = nlz(bits);
//                    result = new Quad(((bits << highestBitPos) & ~highestBit) | (qd1.SignificandBits & highestBit),
//                        qd1.Exponent - highestBitPos);
//                }
//            }
//            else if (qd1.Exponent < qd2.Exponent) //must subtract qd1's significand from qd2, and switch the sign
//            {
//                if (qd2.Exponent >= qd1.Exponent + 64)
//                    return new Quad(qd2.SignificandBits ^ highestBit, qd2.Exponent);
//                        //qd1 too small to matter, switch sign of qd2 and return
...
//                //make sure MSB is 1                       
//                int highestBitPos = nlz(bits);
//                result = new Quad(((bits << highestBitPos) & ~highestBit) | (~qd2.SignificandBits & highestBit),
//                    qd2.Exponent - highestBitPos);
//            }
//            else // (qd1.Exponent == qd2.Exponent)
//            {
//                if (qd2.SignificandBits > qd1.SignificandBits) //must switch sign
//                {
//                    ulong bits = qd2.SignificandBits - qd1.SignificandBits;
//                        //notice that we don't worry about de-implicitizing the MSB--it'd be eliminated by subtraction anyway
//                    int highestBitPos = nlz(bits);
//                    result = new Quad(((bits << highestBitPos) & ~highestBit) | (~qd2.SignificandBits & highestBit),
//                        qd2.Exponent - highestBitPos);
...
//                {
//                    ulong bits = qd1.SignificandBits - qd2.SignificandBits;
//                        //notice that we don't worry about de-implicitizing the MSB--it'd be eliminated by subtraction anyway
//                    int highestBitPos = nlz(bits);
//                    result = new Quad(((bits << highestBitPos) & ~highestBit) | (qd1.SignificandBits & highestBit),
//                        qd1.Exponent - highestBitPos);
...
//            //because the MSB of both significands is 1, the MSB of the result will also be 1, and the product of low bits on both significands is dropped (and thus we can skip its calculation)
//            ulong significandBits = high1*high2 + (((qd1.SignificandBits & lowWordMask)*high2) >> 32) +
//                                    ((high1*(qd2.SignificandBits & lowWordMask)) >> 32);
...
//                    new Quad(
//                        ((qd1.SignificandBits ^ qd2.SignificandBits) & highestBit) |
//                        ((significandBits << 1) & ~highestBit), qd1.Exponent + qd2Exponent);
//            }
//            else
//            {
...
//                result =
//                    new Quad(
//                        ((qd1.SignificandBits ^ qd2.SignificandBits) & highestBit) | (significandBits & ~highestBit),
//                        qd1.Exponent + qd2Exponent);
//            }

//            if (qd2Exponent < 0 && result.Exponent > qd1.Exponent)
//                //did the exponent get larger after adding something negative?
//                return Zero; //underflow
//            else if (qd2Exponent > 0 && result.Exponent < qd1.Exponent)
//                //did the exponent get smaller when it should have gotten larger?
...
//        {
//            return (qd1.SignificandBits == qd2.SignificandBits && qd1.Exponent == qd2.Exponent &&
//                    qd1.Exponent != notANumberExponent);
//                // || (qd1.Exponent == long.MinValue && qd2.Exponent == long.MinValue);
//        }
...
//            else if (qd2.Exponent <= notANumberExponent) //finite * zero/infinity/NaN            
//                return
//                    specialGreaterThanTable[(int) (4 + (qd1.SignificandBits >> 63)), (int) (qd2.Exponent - zeroExponent)
//                        ];
...
//                    return qd1.Exponent < qd2.Exponent ||
//                           (qd1.Exponent == qd2.Exponent && qd1.SignificandBits < qd2.SignificandBits);
...
//            else if (qd2.Exponent <= notANumberExponent) //finite * zero/infinity/NaN            
//                return
//                    specialLessThanTable[(int) (4 + (qd1.SignificandBits >> 63)), (int) (qd2.Exponent - zeroExponent)];
...
//                return new Quad((value.SignificandBits >> (int) (-value.Exponent)) << (int) (-value.Exponent),
//                    value.Exponent);
//            }
//        }
...
//                return new Quad((~highestBit & (bits << shift)) | (highestBit & value.SignificandBits),
...
//                return specialDoubleLogTable[(int) (value.Exponent - zeroExponent)];
...
//                    return
//                        new Quad(
//                            (positive ? 0 : highestBit) |
//                            (~highestBit &
//                             ((ulong) bytes[bytes.Length - 2] << 56 | (ulong) bytes[bytes.Length - 3] << 48 |
//                              (ulong) bytes[bytes.Length - 4] << 40 | (ulong) bytes[bytes.Length - 5] << 32 |
//                              (ulong) bytes[bytes.Length - 6] << 24 | (ulong) bytes[bytes.Length - 7] << 16 |
//                              (ulong) bytes[bytes.Length - 8] << 8 | (ulong) bytes[bytes.Length - 9])),
//                            (bytes.Length - 9)*8);
//                else //shift bits up
//                {
//                    ulong bits = (ulong) bytes[bytes.Length - 1] << 56 | (ulong) bytes[bytes.Length - 2] << 48 |
//                                 (ulong) bytes[bytes.Length - 3] << 40 | (ulong) bytes[bytes.Length - 4] << 32 |
//                                 (ulong) bytes[bytes.Length - 5] << 24 | (ulong) bytes[bytes.Length - 6] << 16 |
//                                 (ulong) bytes[bytes.Length - 7] << 8 | (ulong) bytes[bytes.Length - 8];
//                    int shift = nlz(bits);
...
//                else
//                    return
//                        new System.Numerics.BigInteger((value.SignificandBits | highestBit) >> ((int) -value.Exponent));
//            }

//            if (value.Exponent > int.MaxValue)
//                //you can presumably get a BigInteger bigger than 2^int.MaxValue bits, but you probably don't want to (it'd be several hundred MB).
//                throw new InvalidCastException(
//                    "BigIntegers do not permit left-shifts by more than int.MaxValue bits.  Since the exponent of the quad is more than this, the conversion cannot be performed.");
...
//            if (value.SignificandBits >= highestBit)
//                throw new ArgumentOutOfRangeException("Cannot convert negative value to ulong");
...
//                case zeroExponent:
//                    return 0;
//                case infinityExponent:
//                    return double.PositiveInfinity;
//                case negativeInfinityExponent:
//                    return double.NegativeInfinity;
//                case notANumberExponent:
//                    return double.NaN;
//            }
...
//                {
//                    ulong bits = (value.SignificandBits & highestBit) |
//                                 ((value.SignificandBits | highestBit) >> (int) (-value.Exponent - 1086 + 12));
//                    return *((double*) &bits);
//                }
//                else
//                    return 0;
...
//                if (bits >= 0x7ffUL)
//                    return value.SignificandBits >= highestBit ? double.NegativeInfinity : double.PositiveInfinity;
//                        //too large

//                bits = (value.SignificandBits & highestBit) | (bits << 52) |
//                       (value.SignificandBits & (~highestBit)) >> 11;
...
//                        return "-" + SignificandBits.ToString("x") + "*2^" +
//                               (Exponent >= 0 ? Exponent.ToString("x") : "-" + (-Exponent).ToString("x"));
//                    else
//                        return (SignificandBits | highestBit).ToString("x") + "*2^" +
//                               (Exponent >= 0 ? Exponent.ToString("x") : "-" + (-Exponent).ToString("x"));
...
//                        else
//                            return sign + "0." + new string('0', (int) ((-iExp) - 1)) +
//                                   dVal.ToString(System.Globalization.CultureInfo.InvariantCulture).Remove(1, 1);
//                    }
...
//                                return sign + dValString.Substring(0, 1 + (int) iExp) + "." +
//                                       dValString.Substring(1 + (int) iExp);
//                            else
...
//                    returnScientific:
//                    return sign + dVal.ToString(System.Globalization.CultureInfo.InvariantCulture) + "E" +
//                           (iExp >= 0 ? "+" + iExp : iExp.ToString());
...
//                        return (this.SignificandBits >= highestBit ? "-" : "") +
//                               ((this.SignificandBits | highestBit) >> (int) (-this.Exponent)).ToString();
...
//                    return (this.SignificandBits >= highestBit ? "-" : "") + resultString + "e" + (e >= 0 ? "+" : "") +
//                           e;
...
//            {
//                return other.Exponent == notANumberExponent ? 0 : -1;
//                    //If both NaN, return 0; otherwise, this NaN is "less than" everything else
//            }
